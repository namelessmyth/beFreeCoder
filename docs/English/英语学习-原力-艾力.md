...
transform /trænsˈfɔːrm/  v.使改观，使变形，使转化  n.（数，语言学）变换式，转换句
routine /ruːˈtiːn/  n.常规，惯例；生活乏味，无聊  adj.常规的，例行的
ordinary /ˈɔːrd(ə)neri/  adj.普通的，平常的  n.常见的人（或事物）（the ordinary）
