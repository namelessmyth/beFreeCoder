...
```mermaid
gantt
title 过去时（假设今天是2023年5月1日）
dateFormat YYYY-MM-DD
section 今天
今天          :crit, milestone, now, 2023-05-01, 1h
section 一般过去时
过去发生过      :s1, 2023-04-28, 2h
过去常常1       :s2, 2023-04-28, 2h
过去常常2       :s3, 2023-04-29, 2h
过去常常3       :s3, 2023-04-30, 2h
section 过去进行时
截止过去某个时间正在发生     :active, d1, 2023-04-29, 2d
事件1-过去             :done,d2, 2023-04-28, 1h
紧接着事件1-将要发生     :active,d3, after d2, 1h
过去总是在做-感情        :active,d4, 2023-04-28, 3h
过去总是在做-感情        :active,d5, 2023-04-29, 3h
过去总是在做-感情        :active,d6, 2023-04-30, 3h
section 过去完成时
截止某个时间点已经完成    :done,c2, 2023-04-28, 2d
截止某个时间点已经完成且可能持续    :done,c3, 2023-04-28, 2d
section 过去完成<br>进行时
截止过去某个时间一直在做且可能持续         :active,f1, 2023-04-28, 2d
```
...
```mermaid
gantt
title 现在时（假设今天是2023年5月1日）
dateFormat YYYY-MM-DD
section 今天
今天          :crit, milestone, now, 2023-05-01, 1h
section 一般现在时
现在的情况状态   :active,s1, 2023-05-01, 2h
经常性习惯性     :active,s2, 2023-05-01, 2h
事实真理        :active,s3, 2023-05-01, 2h
条件状语从句-将来        :s4, 2023-05-02, 2h
section 现在进行时
现在正在发生                 :active, d1, 2023-04-30, 3d
当前经常发生，但现在可能没发生  :active, d2, 2023-04-30, 3d
现在总是在做-感情        :active,d4, 2023-04-30, 2h
现在总是在做-感情        :active,d5, 2023-05-01, 2h
现在总是在做-感情        :active,d6, 2023-05-02, 2h
section 现在完成时
截止到现在已经完成，可能对现在产生影响     :done,c1, 2023-04-30, 1d
截止到现在已经完成，并可能持续下去         :c2, 2023-04-30, 2d
section 现在完成<br>进行时
从过去开始持续至今并将延续至将来         :f1, 2023-04-30, 3d
```
...
```mermaid
gantt
title 将来时（假设今天是2023年5月1日）
dateFormat YYYY-MM-DD
section 今天
今天          :crit, milestone, now, 2023-05-01, 1h
section 一般将来时
将来打算要做某事    :s1, 2023-05-02, 2h
即将要做           :s2,after now, 2h
section 将来进行时
将来正在发生                 :d1, 2023-05-02, 2d
section 将来完成时
截止到将来某个时间已经完成     :done, c1, 2023-05-01, 2d
持续到将来某个时间，并可能持续下去     :c2, 2023-05-01, 2d
section 将来完成<br>进行时
持续到将来某个时间，并可能持续下去，期间一直在进行         :f1, 2023-05-01, 3d
```
...
```mermaid
gantt
title 过去将来时（假设今天是2023年5月1日）
todayMarker off
dateFormat YYYY-MM-DD
section 今天
今天          :crit, milestone, now, 2023-05-01, 1h
section 一般过去<br>将来时
过去某个动作    :done, s1, 2023-04-30, 2h
在过去某个动作之后的将来发生     :s2,after s1, 2d
section 过去将来<br>进行时
过去某个动作    :done, d1, 2023-04-30, 2h
在过去某个动作之后的某个特定时间段内正在发生           :active,after d1,2023-05-01, 2d
section 过去将来<br>完成时
过去某个动作    :done, a1, 2023-04-30, 2h
在过去某个动作之后的某个特定时间段内已经完成            :done,after a1, 8h
section 过去将来<br>完成进行时
过去某个动作    :done, f1, 2023-04-30, 2h
在过去某个动作之后的某个特定时间段内持续进行并可能继续下去 :after f1, 2d
```
...
![img](https://pic2.zhimg.com/80/v2-6decea906b2d75596a943cd5066339cd_1440w.jpg)
...
![img](https://pic3.zhimg.com/80/v2-b8dc8e993f76a406aa86a100793a7f76_1440w.webp)
...
![img](https://pic2.zhimg.com/80/v2-b418b9966c72d0ee2b600c70d1556085_1440w.webp)
...
![img](https://pic2.zhimg.com/80/v2-7eface57fb5d5cb2649e0985c6c271a9_1440w.webp)
...
![img](https://pic3.zhimg.com/80/v2-fc976492e328f83dc3d9d75b8fe30c26_1440w.webp)
...
![img](https://pic2.zhimg.com/80/v2-63b71b81058a55ac98ce02d3be492c35_1440w.webp)
...
![img](https://pic1.zhimg.com/80/v2-e15b96e2dd7430f6144cae2aab657530_1440w.webp)
...
| 机构名称 | 价格(每年) | 介绍                                                         | 老师                 |
| -------- | ---------- | ------------------------------------------------------------ | -------------------- |
| 新东方   | 1万~3万    | 在国内比较有名，适合需要短期提升英语水平的人且预算充足的人   | 以中教为主，少数外教 |
| 必克英语 | 1万~2万    | 教学内容个性化定制，根据每个人情况针对性教学与报价。课程种类和覆盖范围较窄，限制学习者的学习深度。 | 欧美固定外教         |
| Cambly   | 5千~1万    | 很多博主推荐过，自选老师，适合有一定英语基础的学生。可以按月，季度付费 | 美英澳加，不固定     |
| 阿卡索   | 15元/节    | 性价比高，1v1外教，网上差评较多。                            | 菲为主，含英美       |
