...
3. 性能优化原则，导致性能问题的可能原因，性能问题定位，不要迷恋优化器
4. 英语听力练习，《海贼王真人版》，听到00:22:54
...
3. 英语：记忆之前学过的美剧中出现的单词，在Cambly上约了一节试听课和英国外教沟通了20分钟，晚上订了艾力老师的课程。
   ...
   2. 在Cambly上找外教学英语，优势是可以了解外国人的思维习惯，文化差异，克服和外国人沟通的障碍。缺点是需要一定的口语基础否则就是全程尬聊。靠词典沟通。还有并不是每个外教都有体系化的教学方法的，今天遇到的只是在和我闲聊。
   3. 下午在抖音上找到了一位北大的艾力老师(https://www.zhihu.com/question/27061190)，花了1元预定了4天的直播课。本想慢慢观察一下效果怎么样。但晚上上了他的直播课之后，想法改变了，这个老师的英语水平应该已经超过很多普通的外国人了。被这个老师的人格魅力和专业水平深深吸引，晚上就下单买了全部课程（￥3980）。1月1日正式开始学习。
...
1. 技术：《[飞滴出行网约车项目](https://www.mashibing.com/study?courseNo=1537&sectionNo=77427)》学到视频169。学习MybatisPlus的代码生成器的使用方法。
   1. 学习高德猎鹰轨迹服务的接口使用方法。下载并学习Jmeter的使用。
...
1. 技术：《[飞滴出行网约车项目](https://www.mashibing.com/study?courseNo=1537&sectionNo=77427)》学到视频261。只挑了重点学，没有每个视频都详细看。
   1. 学习了JMeter做并发测试的步骤并在本地操作了一遍。学习批量插入数据的步骤。
   2. 学习支付整体流程。支付宝沙箱环境。
   3. 3月份准备开始找工作了，进入总复习阶段。
2. 周报：完成本周周报，下周计划。
3. 英语：晨读打卡。复习单词与发音。
...
1. 技术：根据目前学到的知识，整理系统架构图：https://www.processon.com/view/link/65d3891418fbfc6b5eefa0f0
2. 英语：晨读打卡。TPO01-sec4，复习单词，原力课程presentation。
...
1. 技术：面试题复习-Java核心。AIO、BIO、NIO。深拷贝和浅拷贝。整理简历要点。重新整理HashMap实现原理
   1. equals和hashcode方法注意事项。

2. 英语：晨读打卡。TPO01-Set5做完。
...
1. 技术：面试题复习-Java核心。目前初步结束。补充了多道IO相关的面试题。
2. 英语：晨读打卡。背单词与发音30。
...
1. 学习时间：07:00~23:25，12小时
2. 技术：整理JVM面试题。JVM是什么，类加载流程及相关概念。双亲委派。CPU100%的解决过程
3. Leetcode：[70. 爬楼梯](https://leetcode.cn/problems/climbing-stairs/)，很少使用动态规划，看答案都看了一小时。
4. 英语：晨读打卡。系统课A1-社交口语
...
1. 学习时间：07:00~23:25，12小时
2. 面试：今天进行了1场电话面试，整个过程感觉都不知道说什么，都在等面试官问我问题，自我介绍都忘了，场面一度很尴尬。反馈出来最近一段时间一直在学习和总结通用知识，针对面试时的沟通方式和沟通内容，准备的严重不足。面试是一种自我营销，要想尽办法主动突出自己的优点。明天开始要在这上面多花时间了。
3. 技术：整理JVM面试题。目前面试题整理速度过慢，明天要提速了。
4. Leetcode：[887. 鸡蛋掉落](https://leetcode.cn/problems/super-egg-drop/)，复习70。
5. 英语：晨读打卡。背单词。系统课A1-旅游口语
...
1. 学习时间：06:30~23:30，12小时
2. 求职：更新51job，猎聘上的简历。编写英文简历。
3. 技术：面试题-Redis-复习。[69. x 的平方根 ](https://leetcode.cn/problems/sqrtx/)
4. 英语：晨读学习，单词复习。
...
1. 学习时间：06:30~23:10，14小时
2. 技术：面试题-Redis-复习结束。微服务开始整理。微服务和分布式的关系，和SOA的区别，Serverless，康威定律。
3. 英语：晨读学习，单词复习。
...
1. 学习时间：06:30~23:10，8小时
2.  技术：面试题-微服务。nacos，灰度发布，蓝绿部署。注册中心选型。CAP
3. 英语：晨读学习，单词复习。
...
1. 学习时间：14:30~23:20，6小时。本周周报+下周计划。
2. 技术：面试题-微服务-结束。BASE，熔断限流降级。Seata事务模式（AT）。Dubbo和SpringCloud的区别，链路追踪实现
   1. HashMap如何解决Hash冲突（链地址法，再哈希）。LinkedHashMap实现LRU
...
2. 面试题：Spring。Bean生命周期，自我介绍，以后每个面试题都要尽量说一遍，而不是自我感觉理解就行了。今天自我介绍都练了2小时。
3. 算法：[198. 打家劫舍（复习）](https://leetcode.cn/problems/house-robber/)
4. 英语：晨读学习，单词复习40。
...
1. 学习时间：06:30~22:50，8小时。

2. 面试：上午去面试了，下午整理面试题。总体面的不好，要参考费曼学习法要把学到的知识讲出来。而不是仅仅理解和做笔记

   1. 介绍一下用过的JVM调优工具（2024-03-13，1）

      OutOfMemoryError内存溢出有哪些解决方式（2024-03-13，1）

      介绍一下垃圾回收分代算法。（2024-03-13，1）

      Synchronized和ReentrantLock的比较（2024-03-13，1）

      ConcurrentHashmap如何保证线程安全。（2024-03-13，1）

      有哪些方案可以让Hashmap线程安全（2024-03-13，1）

      HashMap存在哪些问题？使用时需要注意的。（2024-03-13，1）

      rabbitmq的应答模式有哪些？（2024-03-13，1）

      Spring的事务传播机制有哪些？默认的是哪个？（2024-03-13，1）

      Redis的持久化有哪两种方式，优缺点？（2024-03-13，1）

      Redis的分布式锁的问题及解决方案。（2024-03-14，1）

      有没有用过ES，用在什么场景下，优缺点。（2024-03-14，1）
...
1. 学习时间：06:30~22:47，12小时。
2. 面试题：Spring。Spring循环依赖与三级缓存，AOP使用，介绍，原理，应用场景。
3. 算法：复习leetcode1和20
4. 英语：晨读学习，单词复习52。
...
1. 学习时间：08:10~23:49，6小时。
2. 面试题：MQ使用场景，多个MQ对比，RocketMQ开源版本的功能限制，RabbitMQ中死信的应用场景，
3. 英语：晨读学习。ZeroMQ，使用场景
