...
在上面的示例中，一个线程可以通过调用await()方法等待，另一个线程可以通过调用signal()方法唤醒等待的线程。这样就实现了线程间的协作。
...
![](https://img-blog.csdnimg.cn/2021050623061321.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3RpYW56aG9uZ2hhb3Fpbmc=,size_16,color_FFFFFF,t_70)
