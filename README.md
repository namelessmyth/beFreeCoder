...
分享的内容包括但不仅限于：架构设计，求职资料，Java基础、多线程并发、JVM、数据库等等，详见：[知识库地图](#知识库地图🗺️)。

**赠人玫瑰手有余香。知识库会持续保持更新，欢迎收藏或加星**！O(∩_∩)O😄😃💖💗💞。[更新记录](#更新记录🤠)
...
Git本身也有[每次提交的记录](https://gitee.com/namelessmyth)，所以这里仅记录比较大的版本更新记录。
