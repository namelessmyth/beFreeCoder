...
<a href="https://github.com/namelessmyth/git-doc" target="_blank"><img alt="Github" src="https://img.shields.io/github/stars/namelessmyth/git-doc?style=social" />
</a>
</p>
...
| 1.8  | Gem shen | 2024-02-27 | [管理文件模版](#文件模版)更新。开发招聘模版，周报模版，工作量评估模版 |
...
- 公司岗位
  - [🙌求职-公司岗位-苏州](docs/Job/求职-公司岗位要求.md)
- 简历&面试
...
- 面试题
  ...
  - [✅面试题-微服务-md](Java/Job/求职-面试题-微服务.md)
...
- 设计模式
  - [✅设计模式-Java-学习笔记-md](Java/mashibing/学习笔记-Java-设计模式.md)
...
- 综合
    - [✅数据库综合-学习笔记-md](Java/mashibing/学习笔记-数据库-Gem.md)
...
- 工作量评估
    - [✅工作量评估模版-项目开发-整体](docs/Management/template/工作量评估模版-项目开发-整体.xlsx)
